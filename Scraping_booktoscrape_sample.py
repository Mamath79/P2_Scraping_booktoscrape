...
def extract_book_data(y):
    ...
    star_rating = soup.find("p",class_="star_rating")
...
def category_book_data_csv_and_download_img(v):
    properties = ["book_url", "book_title", "description" ,"img link","star_rating", "upc", "product type", "price (excl. tax) en £", "price (incl. tax) en £", "tax en £", "availabilily", "numbers of review"]
